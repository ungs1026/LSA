...
const allEsthersData = [
  { name: "루테란", eng_name: "Lutheran", group: "(구) 에스더", race: "인간", title: "사슬전쟁의 영웅", type: 'character', page: 'characters', role: "에스더의 맹주, 리더", img: charNbLutheran, bg: charBgLutheran, subtitle: "Luteran the King", eng_subtitle: "Luteran the King", basicInfo: "패자의 검을 사용하는 위대한 왕. 그의 리더십 아래 7인의 에스더가 뭉칠 수 있었다.", eng_basicInfo: "A great king who wields the Sword of the Vanquisher. Under his leadership, the seven Esthers were able to unite.", combatInfo: "모든 에스더의 힘을 조율하고 아크의 힘을 개방하는 능력을 지녔다. 직접적인 전투력 또한 최상위권에 속했다.", eng_combatInfo: "He possessed the ability to coordinate the powers of all Esthers and unlock the power of the Ark. His direct combat power was also among the highest.", description: "아크라시아를 구한 위대한 영웅이자, 루테란 왕국의 초대 국왕. 에스더의 맹주로서 사슬전쟁을 승리로 이끌었으나, 패자의 검에 의해 깊은 잠에 빠졌다.", eng_description: "A great hero who saved Arkesia and the first king of the Luterra Kingdom. As the leader of the Esthers, he led the Chain War to victory, but fell into a deep sleep due to the Sword of the Vanquisher." },
  { name: "시엔", eng_name: "Sien", group: "(구) 에스더", race: "인간", title: "무의 대가", type: 'character', page: 'characters', role: "애니츠의 정신적 지주", img: charNbSien, bg: charBgSien, subtitle: "Sien the Master", eng_subtitle: "Sien the Master", basicInfo: "애니츠의 건국자이자 무의 정점에 선 인물. 그의 무술은 전설로 전해진다.", eng_basicInfo: "The founder of Anihc and a master of martial arts. His martial arts are legendary.", combatInfo: "내공을 이용한 강력한 장법과 육탄전이 특기. 일리아칸과의 전투에서 그의 힘을 봉인하는데 큰 공을 세웠다.", eng_combatInfo: "He specializes in powerful palm strikes and hand-to-hand combat using his inner energy. He played a major role in sealing Iliakan's power during their battle.", description: "애니츠의 위대한 투사이자 현 무투대회 챔피언. 강력한 권법과 불굴의 투지로 적을 압도한다. 현재는 조화의 문을 지키는 역할을 맡고 있다.", eng_description: "A great warrior of Anihc and the current champion of the Martial Arts Tournament. He overwhelms his enemies with his powerful fist techniques and indomitable fighting spirit. He is currently in charge of guarding the Gate of Harmony." },
  { name: "갈라투르", eng_name: "Galatur", group: "(구) 에스더", race: "우마르", title: "전설의 대장장이", type: 'character', page: 'characters', role: "에스더의 무기 제작자", img: charNbGalatur, bg: charBgGalatur,  subtitle: "Galatur the Smith", eng_subtitle: "Galatur the Smith", basicInfo: "우마르 종족 역사상 최고의 대장장이. 그의 손에서 태어난 무기는 신의 힘을 담고 있다고 전해진다.", eng_basicInfo: "The greatest blacksmith in the history of the Umar race. It is said that the weapons born from his hands contain the power of the gods.", combatInfo: "자신이 만든 강력한 망치를 휘두르며 싸운다. 마수군단장 발탄과의 힘 대결에서 밀리지 않았다.", eng_combatInfo: "He fights by wielding a powerful hammer of his own making. He did not back down in a power struggle against the Beast Legion Commander, Valtan.", description: "전설적인 우마르 대장장이. 그의 손에서 태어난 무구는 신의 힘을 담고 있다고 전해진다. 사슬전쟁 당시 에스더들의 무기를 제작했다.", eng_description: "A legendary Umar blacksmith. It is said that the weapons born from his hands contain the power of the gods. He crafted the weapons of the Esthers during the Chain War." },
  { name: "카단", eng_name: "Kadan", group: "에스더", race: "인간", title: "최초의 가디언 슬레이어", type: 'character', page: 'characters', img: charNbKadan, bg: charBgKadan,  subtitle: "Kadan the First", eng_subtitle: "Kadan the First", basicInfo: "모든 것인 베일에 싸인 에스더. 그의 정체와 목적은 아크라시아 최대의 미스터리 중 하나다.", eng_basicInfo: "An Esther shrouded in mystery. His identity and purpose are one of the greatest mysteries in Arkesia.", combatInfo: "어둠군단장 카멘과 유일하게 대적이 가능한 존재. 그의 검술은 신의 경지에 이르렀다고 평가받는다.", eng_combatInfo: "The only being who can stand against the Dark Legion Commander, Kamen. His swordsmanship is considered to have reached the level of the gods.", description: "최초의 가디언 슬레이어이자 에스더 중 최강의 존재. 사슬전쟁 당시, 홀로 여러 군단장과 맞서 싸울 정도의 압도적인 힘을 과시했으며 어둠군단장 카멘과 유일하게 대적 가능한 인물로 묘사된다. 전쟁 후 홀연히 사라졌으나, 베른 남부에서 카멘이 재등장하자 다시 나타나 그와 격돌했다. 현재는 림레이크에서 마지막 전쟁을 준비하고 있다.", eng_description: "The first Guardian Slayer and the strongest of the Esthers. During the Chain War, he displayed overwhelming power, enough to fight several legion commanders alone, and is depicted as the only person who can stand against the Dark Legion Commander, Kamen. He disappeared suddenly after the war, but reappeared and clashed with Kamen when he reappeared in Southern Vern. He is currently preparing for the final war in Lim-Lake.",
    estherSkills: [
  ...
  { name: "아제나", eng_name: "Azena", group: "에스더", race: "실린", title: "로헨델의 여왕", type: 'character', page: 'characters', img: charNbAzena, bg: charBgAzena,  subtitle: "Azena the Queen", eng_subtitle: "Azena the Queen", basicInfo: "냉철하고 이성적인 실린들의 통치자. 그녀의 마력은 대륙을 뒤덮을 정도라고 한다.", eng_basicInfo: "The cool-headed and rational ruler of the Sylvains. Her magical power is said to be enough to cover the continent.", combatInfo: "원소 마법의 대가. 특히 강력한 냉기 마법으로 몽환군단장 아브렐슈드의 군단을 상대했다.", eng_combatInfo: "A master of elemental magic. She confronted the legion of the Phantom Legion Commander, Abrelshud, with particularly powerful ice magic.", description: "실린의 여왕이자 로헨델의 지배자. 강력한 마법과 냉철한 판단력으로 종족을 이끌며, 아크를 지키는 데 중요한 역할을 한다. '이난나'와는 한 몸에서 비롯된 존재로, 질서와 이성을 상징한다. 사슬전쟁 당시 몽환군단장 아브렐슈드와 맞서 싸웠으며, 현재 아크라시아 연합의 핵심적인 인물 중 하나다.", eng_description: "The queen of the Sylvains and the ruler of Rohendel. She leads her race with powerful magic and cool judgment, and plays an important role in protecting the Ark. She is a being who originated from the same body as 'Inanna' and symbolizes order and reason. She fought against the Phantom Legion Commander, Abrelshud, during the Chain War and is currently one of the key figures in the Arkesia Alliance.",
    estherSkills: [
  ...
  { name: "이난나", eng_name: "Inanna", group: "에스더", race: "실린", title: "조화의 성녀", type: 'character', page: 'characters', img: charNbInanna, bg: charBgInanna,  subtitle: "Inanna the Saintess", eng_subtitle: "Inanna the Saintess", basicInfo: "아제나의 또 다른 자아이자, 자애와 조화의 상징. 그녀의 존재만으로도 주변의 상처가 치유된다.", eng_basicInfo: "Azena's other self and a symbol of benevolence and harmony. Her presence alone heals the wounds of those around her.", combatInfo: "강력한 치유 마법과 보호 마법을 사용한다. 아군을 보호하고 적의 사기를 꺾는 데 능하다.", eng_combatInfo: "She uses powerful healing and protection magic. She is skilled at protecting her allies and breaking the enemy's morale.", description: "자애로운 성품을 지닌 위대한 실린. 로헨델의 질서를 상징하는 '아제나'와는 달리, 순수한 빛과 조화를 상징한다. 고대의 사건으로 아제나와 분리되었으며, 현재는 파푸니카를 이끌며 아크라시아 연합에 힘을 보태고 있다.", eng_description: "A great Sylvain with a benevolent nature. Unlike 'Azena', who symbolizes the order of Rohendel, she symbolizes pure light and harmony. She was separated from Azena due to an ancient incident and is currently leading Papunika and contributing to the Arkesia Alliance.",
    estherSkills: [
  ...
  { name: "바훈투르", eng_name: "Bahuntur", group: "에스더", race: "우마르", title: "우마르의 살아있는 전설", type: 'character', page: 'characters', img: charNbBahuntur, bg: charBgBahuntur,  subtitle: "Bahuntur the Legend", eng_subtitle: "Bahuntur the Legend", basicInfo: "호탕하고 의리 넘치는 성격의 대장장이. 갈라투르의 후계자로서 그의 유지를 잇고 있다.", eng_basicInfo: "A blacksmith with a豪快 and loyal personality. As the successor to Galatur, he carries on his legacy.", combatInfo: "거대한 대검을 휘두르는 파괴적인 전투 스타일을 가졌다. 그의 함성만으로도 적들이 공포에 떤다.", eng_combatInfo: "He has a destructive fighting style, wielding a giant greatsword. His roar alone strikes fear into his enemies.", description: "우마르 족의 살아있는 전설이자 전설적인 대장장이 갈라투르의 후계자. 거대한 대검을 자유자재로 다루며, 호탕하고 의리 있는 성격으로 동료들의 신뢰를 받는다. 욘 대륙의 왕 케이사르의 오랜 친구이자 조력자로서, 현재 욘의 우마르들을 이끌고 있다.", eng_description: "The living legend of the Umar tribe and the successor to the legendary blacksmith Galatur. He wields a giant greatsword with ease and is trusted by his comrades for his豪快 and loyal personality. As a longtime friend and helper of King Caesar of the Yorn continent, he currently leads the Umars of Yorn.",
    estherSkills: [
  ...
  { name: "샨디", eng_name: "Shandi", group: "에스더", race: "요즈", title: "환영술의 대가", type: 'character', page: 'characters', img: charNbShandi, bg: charBgShandi,  subtitle: "Shandi the Sage", eng_subtitle: "Shandi the Sage", basicInfo: "장난기 많아 보이지만 세상의 이치를 꿰뚫어 보는 현자. 그의 조언은 늘 에스더들을 올바른 길로 이끈다.", eng_basicInfo: "A sage who appears playful but sees through the principles of the world. His advice always leads the Esthers on the right path.", combatInfo: "강력한 환영 마법으로 적을 교란하고 아군을 돕는다. 광기군단장 쿠크세이튼을 상대로 우위를 점했다.", eng_combatInfo: "He uses powerful illusion magic to confuse his enemies and help his allies. He gained the upper hand against the Mayhem Legion Commander, Kouku-Saton.", description: "요즈 족의 현자이자 위대한 환영술사. 겉보기에는 장난기 많고 유쾌한 노인이지만, 세상의 이치를 꿰뚫어 보는 지혜를 지녔다. 사슬전쟁 당시 광기군단장 쿠크세이튼을 상대하여 그의 광기를 제압했으며, 계승자의 여정에 많은 도움을 주는 조력자 역할을 한다.", eng_description: "A sage of the Yoz tribe and a great illusionist. Although he appears to be a playful and cheerful old man, he possesses the wisdom to see through the principles of the world. During the Chain War, he confronted the Mayhem Legion Commander, Kouku-Saton, and suppressed his madness, and he plays the role of a helper who provides great assistance on the successor's journey.",
    estherSkills: [
  ...
  { name: "니나브", eng_name: "Nineveh", group: "에스더", race: "라제니스", title: "라제니스의 마지막 계승자", type: 'character', page: 'characters', img: charNbNineveh, bg: charBgNineveh,  subtitle: "Nineveh the Punisher", eng_subtitle: "Nineveh the Punisher", basicInfo: "500년의 잠에서 깨어난 라제니스의 영웅. 순수하고 상냥하지만, 활을 들면 누구보다 냉철해진다.", eng_basicInfo: "A hero of the Lazeniths who has awakened from a 500-year slumber. She is pure and gentle, but becomes cooler than anyone else when she holds a bow.", combatInfo: "신궁이라 불릴 정도의 활 솜씨를 자랑한다. 욕망군단장 비아키스를 상대하여 그녀의 매혹을 이겨냈다.", eng_combatInfo: "She boasts archery skills worthy of being called a divine archer. She confronted the Covetous Legion Commander, Vykas, and overcame her fascination.", description: "날개를 가진 종족, 라제니스의 마지막 계승자. 500년간의 긴 잠에서 깨어나 세상의 위기에 맞선다. 활의 명수이며, 가디언과 소통하는 특별한 능력을 지녔다. 순수하고 상냥한 성품이지만, 활을 들면 냉철한 전사로 변모한다. 사슬전쟁 당시 욕망군단장 비아키스를 상대했으며, 현재는 엘가시아에서 아크라시아 연합군을 돕고 있다.", eng_description: "The last successor of the winged race, the Lazeniths. She awakens from a long 500-year slumber to face the world's crisis. She is a master of the bow and has a special ability to communicate with Guardians. She has a pure and gentle personality, but transforms into a cool-headed warrior when she holds a bow. She confronted the Covetous Legion Commander, Vykas, during the Chain War and is currently helping the Arkesia Alliance in Elgacia.",
    estherSkills: [
  ...
  { name: "웨이", eng_name: "Wei", group: "에스더", race: "인간", title: "애니츠의 대사부", type: 'character', page: 'characters', img: charNbWei, bg: charBgWei,  subtitle: "Wei the Hegemon", eng_subtitle: "Wei the Hegemon", basicInfo: "'패왕'이라 불리는 애니츠의 살아있는 전설. 그의 주먹은 산을 부수고 바다를 가른다고 전해진다.", eng_basicInfo: "The living legend of Anihc, known as the 'Hegemon'. It is said that his fists can shatter mountains and part the seas.", combatInfo: "강력한 기공술을 바탕으로 한 파괴적인 권법을 사용한다. 그의 등장만으로도 전장의 판도가 바뀐다.", eng_combatInfo: "He uses a destructive fist technique based on his powerful ki manipulation. His appearance alone changes the tide of battle.", description: "애니츠의 대사부. '패왕'이라는 이명을 가졌으며, 강력한 기공술과 무술 실력으로 대륙 최고의 고수 중 한 명으로 꼽힌다. 도의 결계를 수호하는 임무를 맡고 있으며, 그의 등장만으로도 전장의 판도를 바꿀 수 있는 강력한 존재이다.", eng_description: "The grand master of Anihc. He has the nickname 'Hegemon' and is considered one of the top masters on the continent due to his powerful ki manipulation and martial arts skills. He is in charge of protecting the barrier of the Tao, and he is a powerful being who can change the tide of battle with his appearance alone.",
    estherSkills: [
  ...
  { name: "실리안", eng_name: "Silian", group: "에스더", race: "인간", title: "루테란의 왕", type: 'character', page: 'characters', img: charNbSilian, bg: charBgSilian,  subtitle: "Silian the Commander", eng_subtitle: "Silian the Commander", basicInfo: "영웅 루테란의 후손이자 현재 루테란의 왕. 내전을 극복하고 분열된 아크라시아를 하나로 모으고 있다.", eng_basicInfo: "A descendant of the hero Lutheran and the current king of Luterra. He is overcoming a civil war and uniting the divided Arkesia.", combatInfo: "패자의 검을 사용하여 왕가의 검술을 펼친다. 리더로서 연합군을 지휘하는 능력이 탁월하다.", eng_combatInfo: "He uses the Sword of the Vanquisher to perform the royal swordsmanship. As a leader, he has an excellent ability to command the allied forces.", description: "영웅 루테란의 후손이자 현재 루테란의 왕. 어릴 적 겪은 비극과 왕국의 내전을 극복하고 분열된 아크라시아를 하나로 모으는 구심점 역할을 하고 있다. 패자의 검을 사용하여 왕가의 검술을 펼치며, 아크라시아 연합군의 총사령관으로서 탁월한 리더십을 발휘한다.", eng_description: "A descendant of the hero Lutheran and the current king of Luterra. He is overcoming the tragedy he experienced as a child and the kingdom's civil war, and is serving as a focal point for uniting the divided Arkesia. He uses the Sword of the Vanquisher to perform the royal swordsmanship, and as the commander-in-chief of the Arkesia Alliance, he displays excellent leadership.",
    estherSkills: [
...
export const commanders = [
  { name: "발탄", eng_name: "Valtan", group: "카제로스 군단장", race: "악마", title: "마수군단장", type: 'character', page: 'characters', role: "선봉 돌격대장", img: charNbValtan, bg: charBgValtan,  subtitle: "Beast-Lord of Ruin", eng_subtitle: "Beast-Lord of Ruin", basicInfo: "카제로스 군단의 선봉을 맡는 파괴의 화신. 그의 도끼 앞에서는 모든 것이 먼지가 될 뿐이다.", eng_basicInfo: "The incarnation of destruction who leads the vanguard of Kazeros's legion. Before his axe, everything turns to dust.", combatInfo: "자신의 거대한 도끼와 육체를 이용한 파괴적인 공격이 특징. 분노하면 주변 지형까지 파괴하며 싸운다.", eng_combatInfo: "Characterized by destructive attacks using his giant axe and body. When enraged, he fights while destroying the surrounding terrain.", description: "마수군단장. 압도적인 파괴력과 육체를 지닌 존재. 카제로스의 군단 중 선봉에 서서 모든 것을 파괴한다.", eng_description: "Beast Legion Commander. A being with overwhelming destructive power and physique. He stands at the forefront of Kazeros's legion, destroying everything.", bg_x_position: '72%'  },
  { name: "비아키스", eng_name: "Vykas", group: "카제로스 군단장", race: "악마", title: "욕망군단장", type: 'character', page: 'characters', role: "정신 지배 및 타락", img: charNbBiackiss, bg: charBgBiackiss,  subtitle: "Covetous-Lord of Desire", eng_subtitle: "Covetous-Lord of Desire", basicInfo: "매혹적인 외모와 목소리로 상대를 타락시키는 욕망의 화신. 그녀의 유혹에 넘어가지 않은 자는 없다고 한다.", eng_basicInfo: "The incarnation of desire who corrupts others with her captivating appearance and voice. It is said that no one has ever resisted her temptation.", combatInfo: "상대의 욕망을 증폭시켜 스스로 파멸하게 만드는 정신 공격에 능하다. 그녀의 키스는 가장 달콤한 독이다.", eng_combatInfo: "She is adept at mental attacks that amplify the opponent's desires, leading them to self-destruction. Her kiss is the sweetest poison.", description: "욕망군단장. 끝없는 탐욕과 쾌락을 추구하며, 타락한 자들을 지배한다. 매혹적인 외모 뒤에 잔혹한 본성을 숨기고 있다.", eng_description: "Covetous Legion Commander. She pursues endless greed and pleasure, and rules over the corrupted. Behind her captivating appearance, she hides a cruel nature.", bg_x_position: '70%' },
  { name: "쿠크세이튼", eng_name: "Kouku-Saton", group: "카제로스 군단장", race: "악마", title: "광기군단장", type: 'character', page: 'characters', role: "혼돈과 광기 전파", img: charNbKouku, bg: charBgKouku,  subtitle: "Mayhem-Lord of Madness", eng_subtitle: "Mayhem-Lord of Madness", basicInfo: "혼돈과 파괴 그 자체를 즐기는 미치광이. 그의 등장만으로도 세상의 질서는 무너지고 광기가 피어난다.", eng_basicInfo: "A madman who enjoys chaos and destruction itself. His appearance alone shatters the world's order and gives rise to madness.", combatInfo: "예측 불가능한 움직임과 환각을 이용해 상대를 농락한다. 그의 장난감 상자는 곧 죽음의 무대다.", eng_combatInfo: "He mocks his opponents with unpredictable movements and hallucinations. His toy box is a stage of death.", description: "광기군단장. 혼돈과 파괴 그 자체를 즐기는 미치광이. 예측 불가능한 공격과 환각으로 상대를 농락한다.", eng_description: "Mayhem Legion Commander. A madman who enjoys chaos and destruction itself. He mocks his opponents with unpredictable attacks and hallucinations.", bg_x_position: '88%' },
  { name: "아브렐슈드", eng_name: "Abrelshud", group: "카제로스 군단장", race: "악마", title: "몽환군단장", type: 'character', page: 'characters', role: "군단의 최고 참모, 마법사", img: charNbAbrelshud, bg: charBgAbrelshud, subtitle: "Phantom-Lord of Dreams", eng_subtitle: "Phantom-Lord of Dreams", basicInfo: "카제로스 군단의 두뇌. 그녀의 교활한 계략은 아크라시아 전체를 위협한다.", eng_basicInfo: "The brain of Kazeros's legion. Her cunning schemes threaten all of Arkesia.", combatInfo: "현실과 꿈의 경계를 허무는 강력한 환영 마법을 사용한다. 그녀가 창조한 몽환 세계는 그 누구도 빠져나올 수 없다.", eng_combatInfo: "She uses powerful illusion magic that blurs the line between reality and dreams. No one can escape the dream world she creates.", description: "몽환군단장. 현실과 꿈의 경계를 허무는 강력한 환영 마법의 대가. 아크라시아에 끔찍한 악몽을 선사한다.", eng_description: "Phantom Legion Commander. A master of powerful illusion magic that blurs the line between reality and dreams. She brings terrible nightmares to Arkesia.", bg_x_position: '50%' },
  { name: "일리아칸", eng_name: "Iliakan", group: "카제로스 군단장", race: "악마", title: "질병군단장", type: 'character', page: 'characters', role: "생화학 무기 및 역병", img: charNbIlliakan, bg: charBgIlliakan, subtitle: "Plague-Lord of Corruption", eng_subtitle: "Plague-Lord of Corruption", basicInfo: "부패와 역병을 퍼뜨리는 혐오스러운 존재. 그의 발이 닿는 모든 곳은 생명이 사라지고 죽음의 기운만이 남는다.", eng_basicInfo: "A loathsome being who spreads corruption and plague. Wherever he steps, life vanishes and only the aura of death remains.", combatInfo: "치명적인 질병과 독을 사용하여 상대를 서서히 죽음으로 몰아넣는다. 그의 실험실에서는 끔찍한 괴물들이 태어난다.", eng_combatInfo: "He uses deadly diseases and poisons to slowly drive his opponents to death. Terrible monsters are born in his laboratory.", description: "질병군단장. 부패와 역병을 퍼뜨리는 존재. 그의 발이 닿는 모든 곳은 생명이 사라지고 죽음의 기운만이 남는다.", eng_description: "Plague Legion Commander. A being who spreads corruption and plague. Wherever he steps, life vanishes and only the aura of death remains.", bg_x_position: '50%'},
  { name: "카멘", eng_name: "Kamen", group: "카제로스 군단장", race: "악마", title: "어둠군단장", type: 'character', page: 'characters', role: "군단장들의 정점, 최강의 무력", img: charNbKamen, bg: charBgKamen,  subtitle: "Dark-Lord of Abyss", eng_subtitle: "Dark-Lord of Abyss", basicInfo: "모든 군단장 위에 군림하는 어둠의 화신. 그의 존재만으로도 세상은 빛을 잃고 절망에 빠진다.", eng_basicInfo: "The incarnation of darkness who reigns over all legion commanders. His presence alone causes the world to lose its light and fall into despair.", combatInfo: "어둠의 검을 사용하여 모든 것을 베어버린다. 그의 힘은 에스더 카단과 유일하게 비견될 정도다.", eng_combatInfo: "He uses the Sword of Darkness to cut down everything. His power is said to be comparable only to that of Esther Kadan.", description: "어둠군단장이자 모든 군단장의 정점에 선 존재. 카제로스 다음가는 힘을 지녔다고 알려져 있으며, 그의 존재만으로도 절망을 불러온다.", eng_description: "Dark Legion Commander and the one who stands at the pinnacle of all legion commanders. He is known to have power second only to Kazeros, and his mere presence brings despair.", bg_x_position: '61%' },
];
